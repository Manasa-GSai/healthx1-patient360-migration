...
module "unity_catalog" {
  ...
  environment                      = "stg"
  catalog_name                     = "patient360_stg"
  adls_storage_account_name        = "adlsp360stg"
  service_principal_application_id = var.service_principal_application_id
  service_principal_client_secret  = var.service_principal_client_secret
  azure_tenant_id                  = var.azure_tenant_id
  engineer_group_name              = "patient360-stg-deployers"
  analyst_group_name               = "patient360-stg-analysts"
  admin_group_name                 = "patient360-stg-admins"
